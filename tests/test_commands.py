...
def test_clear_records(records):
    ...
    call_command('clear_records', 'test_app', 'book', days=0, interactive=False)
...
def test_cleardata(records):
    ...
    call_command('cleardata', 'test_app', interactive=False)
...
def test_test_mail_command(mailoutbox):
    call_command('test_mail', to='test@mail.com', interactive=False)
